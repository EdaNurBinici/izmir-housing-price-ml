...
sns.regplot(x='area', y='price', data=df, scatter_kws={'alpha':0.5, 'color':'green'}, line_kws={'color':'red'})
...
sns.barplot(x=ilce_fiyatlari.index, y=ilce_fiyatlari.values, palette='viridis', hue=ilce_fiyatlari.index, legend=False)
...
sns.boxplot(x='district', y='price', data=df, order=order, palette='viridis', hue='district', legend=False)
...
sns.barplot(x=m2_degerleri.index, y=m2_degerleri.values, palette='magma', hue=m2_degerleri.index, legend=False)
plt.xticks(rotation=45)
...
sns.heatmap(numeric_df.corr(), annot=True, fmt=".2f", cmap='coolwarm', linewidths=1, linecolor='white')
